...
Usage:
    ...
    python generate_pool_shards.py --episodes 100000 --s3-prefix s3://my-bucket/dataraw_v2
...
def create_metadata(output_dir: str, total_episodes: int, shard_size: int) -> str:
    ...
    metadata = {
        ...
        'generation_notes': {
            'policy': 'diverse_v2',
            'description': 'Expanded bot archetypes, spawn layouts, and mild per-episode physics randomization.',
        },
    }
