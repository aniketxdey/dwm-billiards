#!/usr/bin/env bash
set -euo pipefail
RUN_ID="full_v3collision_20260223_094313"
S3_DATA_PREFIX="s3://videogen-pool-v2-237586137680/dataraw_v3/full_v3collision_20260223_094313"
S3_LOG_PREFIX="s3://videogen-pool-v2-237586137680/ops/runs/full_v3collision_20260223_094313"
ARTIFACT_URI="s3://videogen-pool-v2-237586137680/ops/artifacts/full_v3collision_20260223_094313/data_generation_package_v3.tar.gz"
EPISODES=200000
SHARD_SIZE=100
FRAMES=600
WORKERS=64
...
cd "${RUN_ROOT}/data_generation_package_v3"
rm -rf "${RUN_ROOT}/venv"
...
summary = {
  ...
  "generator_variant": "data_generation_package_v3_collision_heavy"
}
...
if [ ${GEN_EXIT} -ne 0 ]; then exit ${GEN_EXIT}; fi
